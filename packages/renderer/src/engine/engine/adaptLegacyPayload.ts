/**
 * @le-relief/renderer – Legacy Payload Adapter
 *
 ...
 *   taux        → data-card  (premium navy/gold financial card)
 */

import type { IGFormattedPayload, IGQueueItem, IGPostType, IGSlide } from "@le-relief/types";
...
export function adaptLegacyPayload(
  ...
  const igType     = (queueItem.igType ?? queueItem.postType) as IGPostType;
