/**
 * @le-relief/renderer – Build Slides (Pipeline Orchestrator)
 *
 * Wires the full validation pipeline from raw ContentIntakeInput to a
 * fully validated EnginePost ready for rendering.
 *
...
/**
 * Run the full build pipeline and return a validated EnginePost.
 *
 ...
 */
export function isExportReady(post: EnginePost): boolean {
