/**
 * @le-relief/renderer – QA Preview Layer: Fit Report
 *
...
import type { EnginePost, SlideValidationMeta } from "../types/post.js";
 ...
 *
 * @param post  The validated EnginePost (from buildPost()).
 */
export function buildFitReport(post: EnginePost): FitReportSummary {
