/**
 * @le-relief/renderer – QA Preview Layer: Contact Sheet Generator
 *
...
function buildSheetHtml(post: EnginePost, slides: SlidePreviewData[]): string {
...
<body>
  ...
  <div class="footer">
    ...
    <span>${BRAND.wordmark.left} ${BRAND.wordmark.right} · QA</span>
  </div>
</body>
</html>`;
}
