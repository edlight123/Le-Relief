...
export async function createArticle(data: CreateArticleRepoInput) {
  ...
  await ref.set({
    ...
    keyPoints: (normalizedInput.keyPoints as string[] | null | undefined) || null,
    context: (normalizedInput.context as string | null | undefined) || null,
    sources: (normalizedInput.sources as Array<{ title: string; url: string }> | null | undefined) || null,
    ...
    priorityLevel: (normalizedInput.priorityLevel as string | null | undefined) || null,
    isBreaking: Boolean(normalizedInput.isBreaking),
    isHomepagePinned: Boolean(normalizedInput.isHomepagePinned),
